plotting_distributions <- function(Distribution_test_mat = test,
                                   ...
                                   vector_colors = c(dim(Distribution_test_mat)[1])) {
...
plot(average_distribution_plot, ylim = c(10,0), xlim = c(0,5), col = vector_colors)

abline(a = model_slope, b = model_intercept, col = colour)

if (random_distributions_plot == F) { NA } else { 
